...
require_user_login(); // Si définie dans functions.php
...
<div class="container">
    ...
    <div class="actions">
        ...
        <form method="POST" action="../messages/mdelete_all_received.php" onsubmit="return confirm('Supprimer TOUS les messages reçus ?');" style="margin: 0;">
