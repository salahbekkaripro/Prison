...
<div id="app-content">
  ...
  <form method="post" id="login-form" class="form-input">
    ...
    <img id="captcha-image" src="../actions/captcha_image.php" alt="Captcha" style="margin-bottom: 10px; border-radius: 8px; border: 1px solid rgba(255,165,0,0.5); box-shadow: 0 0 8px rgba(255,165,0,0.4);">
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    if (captchaImage) {
        ...
        captchaImage.src = '../actions/captcha_image.php?t=' + timestamp;
    }
