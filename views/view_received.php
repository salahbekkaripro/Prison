...
// Inclure la base de données AVANT les fonctions si elles en dépendent
require_once '../includes/db.php';          // $pdo défini ici
require_once '../includes/functions.php';   // fonctions, dont require_user_login()

require_user_login();                        // vérification d'authentification
