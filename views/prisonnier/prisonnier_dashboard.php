...
<div class="dashboard-container">
    ...
    <?php foreach ($notifications as $notif): ?>
        <?php if ($notif['type'] === 'pot_de_vin'): ?>
            <div class="alert">
                💸 <?= htmlspecialchars($notif['message']) ?><br>
                <button onclick='repondrePotDeVin(true, <?= $notif['post_id'] ?>)'>Accepter</button>
                <button onclick='repondrePotDeVin(false, <?= $notif['post_id'] ?>)'>Refuser</button>
            </div>
        <?php endif; ?>
    <?php endforeach; ?>
